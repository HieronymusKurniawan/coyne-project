<%-- 
    Document   : halamanKategoriSayur
    Created on : Dec 15, 2021, 12:08:11 PM
...
<html>
    <head>
        ...
        <title>Halaman Kategori Sayur</title>
        ...
        <section class="home" id="home">
            <h1 id="deskripsibener">
                ...
                <div class="content">
                    ...
                    Haloo, <span><%=session.getAttribute("login")%></span>                  
                    <h4 id="deskripsibener">Anda sedang melihat menu kategori <span>"Sayur"</span></h4>
                </div>
            </h1>
        </section>
        <section class="categories" id="categories">
            ...
            <div class="box-container">
                ...
                <%
                    ...
                    ResultSet rs = st.executeQuery("select * from produk where kategoriProduk = 'Sayur'");
                    while (rs.next()) {
                %>
